...
SELECT ORDER_STATUS FROM ORDER_HEADER;
SELECT DISTINCT (CONCAT(CUSTOMER_FNAME,' ',CUSTOMER_LNAME)) AS CUSTOMER_FULLNAME FROM ONLINE_CUSTOMER;
SELECT OC.CUSTOMER_ID, (CONCAT(OC.CUSTOMER_FNAME,' ',OC.CUSTOMER_LNAME)) AS CUSTOMER_FULLNAME, OH.ORDER_ID, (OI.PRODUCT_QUANTITY)
